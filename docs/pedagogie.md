...
??? info "Choix des spécialités"
    ...
    Pour plus d'informations sur les spécialités, rendez-vous sur l'onglet [**orientation**](https://jocedoc.github.io/mon_premier_site/orientation/){target=_blank} du présent site.
